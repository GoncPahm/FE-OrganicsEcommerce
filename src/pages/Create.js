    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto mt-16 text-center">
                <h1 className="my-6 text-2xl font-bold">Create New Listing</h1>
                <form onSubmit={handleSubmitCreateListing} className="flex gap-4">
                    ...
                    <div className="flex-1 flex flex-col gap-4">
                        <p className="text-start">
                            <span className="font-bold text-start">Images</span>: The first image will be the cover (max
                            6)
                        </p>
